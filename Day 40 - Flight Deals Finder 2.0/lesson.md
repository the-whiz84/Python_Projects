# Day 40 - Flight Deals Finder 2.0

This lesson is manually reconstructed from this day’s real project files. It focuses specifically on **Flight Deals Finder 2.0** and avoids generic cross-day boilerplate.
...
You build **Flight Deals Finder 2.0** as a day-specific project using `requests`.
...
- **Flight Deals Finder 2.0** is strongest when the main flow is simple and each helper has one clear job.
