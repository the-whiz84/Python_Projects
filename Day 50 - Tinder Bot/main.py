...
# time.sleep(3)
# decline_cookies = driver.find_element(By.XPATH, value='//*[@id="s-1722817178"]/div/div[2]/div/div/div[1]/div[2]/button/div[2]/div[2]/div')
...
# Instructor Solution for project using login with Facebook
from selenium import webdriver
import os
from selenium.webdriver.common.by import By
from selenium.webdriver.common.keys import Keys
...
sleep(2)
fb_login = driver.find_element(By.XPATH, value='//*[@id="s843769042"]/div/div[1]/div/div[1]/div/div/div[2]/div[2]/span/div[2]/button/div[2]/div[2]/div[2]/div/div')
fb_login.click()
